        ...
        if (direction <= HexDirection.E && nextNeighbor != null) {
            ...
            if (cell.Elevation <= neighbour.Elevation) {
                if (cell.Elevation <= nextNeighbor.Elevation) {
                    TriangulateCorner(e1.v4, cell, e2.v4, neighbour, v5, nextNeighbor);
                } else {
                    TriangulateCorner(v5, nextNeighbor, e1.v4, cell, e2.v4, neighbour);
                }
            } else if (neighbour.Elevation <= nextNeighbor.Elevation) {
                TriangulateCorner(e2.v4, neighbour, v5, nextNeighbor, e1.v4, cell);
            } else {
                TriangulateCorner(v5, nextNeighbor, e1.v4, cell, e2.v4, neighbour);
            }
        }
